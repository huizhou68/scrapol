...
2. The present version of the package can achieve an accuracy rate of 75% and 83% at parsing party and district information based on a test of 1000 politicians. I will modify the code to improve the accuracy rate.
